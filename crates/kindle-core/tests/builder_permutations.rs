...
fn test_linear_permutations() {
    ...
    let _l2 = Linear::<s![10, 20], B, kindle_core::prelude::False>::build(()).unwrap();
    ...
    let _l7 = Linear::<Dyn, B, kindle_core::prelude::False>::build((10, 20)).unwrap();
...
fn test_conv1d_permutations() {
    ...
    // 2. Fully static, Bias = False
    let _c2 = Conv1d::<s![16, 3, 3, 1, 1, 1], B, kindle_core::prelude::False>::build(()).unwrap();
    ...
    let _c4 =
        Conv1d::<s![dyn, dyn, 3, 1, 1, 1], B, kindle_core::prelude::False>::build((16, 3)).unwrap();
...
fn test_conv2d_permutations() {
    ...
    // 2. Fully static, Bias = False
    let _c2 = Conv2d::<s![16, 3, 3, 1, 1, 1], B, kindle_core::prelude::False>::build(()).unwrap();
    ...
    // 5. Dynamic channels, Bias = False
    let _c4 =
        Conv2d::<s![dyn, dyn, 3, 1, 1, 1], B, kindle_core::prelude::False>::build((16, 3)).unwrap();
