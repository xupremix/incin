    ...
    ($backend:ty, $storage:ty) => {
            ...
            for $backend
        {
            ...
            fn execute(
                ...
                let attr = request.operation.descriptor().attributes();
                <Self as incin_core::tensor::backend::CreationOps<Self>>::zeros::<f32>(
                    &attr.shape,
                    attr.dtype,
                    &attr.device,
                )
            ...
            for $backend
        {
            ...
            fn execute(
                ...
                let attr = request.operation.descriptor().attributes();
                <Self as incin_core::tensor::backend::CreationOps<Self>>::ones::<f32>(
                    &attr.shape,
                    attr.dtype,
                    &attr.device,
                )
            ...
            for $backend
        {
            ...
            fn execute(
                ...
                let attr = request.operation.descriptor().attributes();
                <Self as incin_core::tensor::backend::CreationOps<Self>>::rand::<f32>(
                    &attr.shape,
                    attr.dtype,
                    &attr.device,
                )
            ...
            for $backend
        {
            ...
            fn execute(
                ...
                let attr = request.operation.descriptor().attributes();
                <Self as incin_core::tensor::backend::CreationOps<Self>>::randn::<f32>(
                    &attr.shape,
                    attr.dtype,
                    &attr.device,
                )
            ...
            for $backend
        {
            ...
            fn execute(
                ...
                let attr = request.operation.descriptor().attributes();
                <Self as incin_core::tensor::backend::CreationOps<Self>>::full::<f32>(
                    attr.value,
                    &attr.shape,
                    attr.dtype,
                    &attr.device,
            ...
            for $backend
        {
            ...
            fn execute(
                ...
                let attr = request.operation.descriptor().attributes();
                <Self as incin_core::tensor::backend::CreationOps<Self>>::arange::<f32>(
                    attr.start,
                    attr.step,
                    &attr.shape,
                    attr.dtype,
            ...
            for $backend
        {
            ...
            fn execute(
                ...
                let attr = request.operation.descriptor().attributes();
                <Self as incin_core::tensor::backend::CreationOps<Self>>::linspace::<f32>(
                    attr.start,
                    attr.end,
                    &attr.shape,
                    attr.dtype,
