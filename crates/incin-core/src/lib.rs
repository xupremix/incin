...
pub mod backend_authoring {
    ...
    pub use crate::exec::{
        ...
        OPERATION_CATALOG, Operation, OperationCatalogEntry, OperationIdentity, OperationKey,
        PrecisionSpec, RuntimePrecisionPolicy, TensorMeta, Validated, ValidatedInvocation, op,
    };
