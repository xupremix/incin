//! Integration coverage for `odd_tensor_extent` on the documented public surface.
use incin_core::dist::{
...
fn odd_tensor_extent(topology: &TwoRankPlanningTopology) {
    let _ = HybridPlanner::plan_tensor_static::<f32, U7, U16, U4, U4>(
        topology,
        8,
        2,
        [10_000; 2],
