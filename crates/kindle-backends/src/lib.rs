...
pub mod candle {
    ...
    impl<S: Shape> Backend<S> for CandleBackend {
        ...
        fn relu(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.relu().map_err(|e| anyhow::anyhow!(e))?) }
        fn gelu(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.gelu_erf().map_err(|e| anyhow::anyhow!(e))?) } // using gelu_erf as fallback for general
        fn abs(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.abs().map_err(|e| anyhow::anyhow!(e))?) }
        fn neg(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.neg().map_err(|e| anyhow::anyhow!(e))?) }
        fn sqrt(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.sqrt().map_err(|e| anyhow::anyhow!(e))?) }
        fn exp(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.exp().map_err(|e| anyhow::anyhow!(e))?) }
        fn log(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.log().map_err(|e| anyhow::anyhow!(e))?) }
        fn tanh(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.tanh().map_err(|e| anyhow::anyhow!(e))?) }
        fn sigmoid(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(::candle_nn::ops::sigmoid(t).map_err(|e| anyhow::anyhow!(e))?) }

        fn mul_scalar(t: &Self::RawTensor, scalar: f64) -> Result<Self::RawTensor> { Ok((t * scalar).map_err(|e| anyhow::anyhow!(e))?) }
        fn add_scalar(t: &Self::RawTensor, scalar: f64) -> Result<Self::RawTensor> { Ok((t + scalar).map_err(|e| anyhow::anyhow!(e))?) }

        fn sum_all(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.sum_all().map_err(|e| anyhow::anyhow!(e))?) }
        fn mean_all(t: &Self::RawTensor) -> Result<Self::RawTensor> { Ok(t.mean_all().map_err(|e| anyhow::anyhow!(e))?) }
...
pub mod ndarray_backend {
    ...
    impl<S: Shape> Backend<S> for NdarrayBackend {
        ...
        fn neg(_t: &Self::RawTensor) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "neg", backend: "Ndarray" }) }
        fn sqrt(_t: &Self::RawTensor) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "sqrt", backend: "Ndarray" }) }
        fn exp(_t: &Self::RawTensor) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "exp", backend: "Ndarray" }) }
        fn log(_t: &Self::RawTensor) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "log", backend: "Ndarray" }) }
        fn tanh(_t: &Self::RawTensor) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "tanh", backend: "Ndarray" }) }
        fn sigmoid(_t: &Self::RawTensor) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "sigmoid", backend: "Ndarray" }) }
        fn mul_scalar(_t: &Self::RawTensor, _scalar: f64) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "mul_scalar", backend: "Ndarray" }) }
        fn add_scalar(_t: &Self::RawTensor, _scalar: f64) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "add_scalar", backend: "Ndarray" }) }
        ...
        fn narrow(_t: &Self::RawTensor, _dim: usize, _start: usize, _len: usize) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "narrow", backend: "Ndarray" }) }
        fn squeeze(_t: &Self::RawTensor, _dim: usize) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "squeeze", backend: "Ndarray" }) }
        fn conv2d(_t: &Self::RawTensor, _w: &Self::RawTensor, _b: Option<&Self::RawTensor>, _s: usize, _p: usize, _d: usize) -> Result<Self::RawTensor> { Err(Error::UnsupportedBackendOperation { op: "conv2d", backend: "Ndarray" }) }
    }
}
