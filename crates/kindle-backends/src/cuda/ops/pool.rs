...
use alloc::sync::Arc;
use kindle_core::prelude::{DTypeId, Result};
...
pub(crate) fn launch_max_pool2d_forward(
    ...
    unsafe {
        ...
        stream
            ...
            .launch(cfg)
            .map_err(|e| {
                kindle_core::prelude::Error::Msg(format!("max_pool2d_forward launch failed: {e:?}"))
            })?;
    }
...
pub(crate) fn launch_avg_pool2d_forward(
    ...
    unsafe {
        ...
        stream
            ...
            .launch(cfg)
            .map_err(|e| {
                kindle_core::prelude::Error::Msg(format!("avg_pool2d_forward launch failed: {e:?}"))
            })?;
    }
