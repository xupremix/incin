...
fn main() -> anyhow::Result<()> {
    ...
    let wi = kindle::nn::Linear::<(Const<10>, Const<20>), Backend>::new()?;
    let wh = kindle::nn::Linear::<(Const<20>, Const<20>), Backend>::new()?;
    let cell = kindle::nn::rnn::RNNCell::new(wi, wh);
    let model = kindle::nn::rnn::RNN::<Const<10>, Const<20>, Backend>::new(cell);
