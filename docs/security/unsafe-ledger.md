...
| Distributed and tuning FFI | `crates/incin-backends/src/dist/nccl/transport.rs`, `crates/incin-backends/src/tuning/identity/cuda.rs` |
| Core tensor representation | `crates/incin-core/src/tensor/ops/manipulation/interop.rs` |
