...
| Stable public facade | **Partial**: explicit root exports coexist with wildcard module exports | Stable/internal names are not yet fully separated | Stable plus misplaced preview names | API-001 summary and source audit | FND-001 |
...
| ONNX macro import | **Partial** stateless eager expansion | No initializers, control flow, custom domains, attributes, or broad opset coverage | Experimental behavior pending FND-001 placement | Macro unit tests | Real ONNX initializer/state loading (deferred) |
