...
| `AxisMask`, `DeviceSet`, cache keys/records | validated value | Encodable axes; nonempty homogeneous devices; bounded/provenanced cache data | Named checked constructors | Constructor and custom deserialization | Named read-only accessors |
