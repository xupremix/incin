...
| 01 | Compile-time shape diagnostics | [`01-shape-diagnostics.md`](01-shape-diagnostics.md) | PARTIAL (2026-07-23): `SameCount` fix landed for `ReshapeShape`, audit found no other E0271 offenders, matmul snapshot added | 00 |
| 02 | IDE extensions + LSP | [`02-ide-extensions.md`](02-ide-extensions.md) | PARTIAL (2026-07-23): `kindle-lsp` proxy + VS Code + Neovim clients done and verified; RustRover fallback only (LSP mode unverified) | 00 |
...
| 04 | Compile-time model stats | [`04-compile-time-stats.md`](04-compile-time-stats.md) | NOT STARTED | — |
| 05 | Observability + scaffolder | [`05-observability-and-scaffolding.md`](05-observability-and-scaffolding.md) | NOT STARTED | — |
